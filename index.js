...
// include: C:\Users\THOMAS~1\AppData\Local\Temp\tmpqlfkqiav.js
...
Module['FS_createPath']("/", "assets", true, true);
    ...
    loadPackage({"files": [{"filename": "/assets/a_bounce.mp3", "start": 0, "end": 10951}, {"filename": "/assets/a_bounce.wav", "start": 10951, "end": 183027}, {"filename": "/assets/s_menu_logo_strip3.png", "start": 183027, "end": 201004}, {"filename": "/assets/s_player.png", "start": 201004, "end": 201257}, {"filename": "/assets/s_tileset.png", "start": 201257, "end": 214393}], "remote_package_size": 214393});

  })();

// end include: C:\Users\THOMAS~1\AppData\Local\Temp\tmpqlfkqiav.js
// include: C:\Users\THOMAS~1\AppData\Local\Temp\tmpsis2ff3x.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\THOMAS~1\AppData\Local\Temp\tmpsis2ff3x.js
// include: C:\Users\THOMAS~1\AppData\Local\Temp\tmpwntx6azy.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\THOMAS~1\AppData\Local\Temp\tmpwntx6azy.js
...
var ASM_CONSTS = {
  395680: ($0) => { var str = UTF8ToString($0) + '\n\n' + 'Abort/Retry/Ignore/AlwaysIgnore? [ariA] :'; var reply = window.prompt(str, "i"); if (reply === null) { reply = "i"; } return reply.length === 1 ? reply.charCodeAt(0) : -1; },  
 395895: () => { if (typeof(AudioContext) !== 'undefined') { return true; } else if (typeof(webkitAudioContext) !== 'undefined') { return true; } return false; },  
 396042: () => { if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return true; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return true; } return false; },  
 396276: ($0) => { if(typeof(Module['SDL2']) === 'undefined') { Module['SDL2'] = {}; } var SDL2 = Module['SDL2']; if (!$0) { SDL2.audio = {}; } else { SDL2.capture = {}; } if (!SDL2.audioContext) { if (typeof(AudioContext) !== 'undefined') { SDL2.audioContext = new AudioContext(); } else if (typeof(webkitAudioContext) !== 'undefined') { SDL2.audioContext = new webkitAudioContext(); } if (SDL2.audioContext) { if ((typeof navigator.userActivation) === 'undefined') { autoResumeAudioContext(SDL2.audioContext); } } } return SDL2.audioContext === undefined ? -1 : 0; },  
 396828: () => { var SDL2 = Module['SDL2']; return SDL2.audioContext.sampleRate; },  
